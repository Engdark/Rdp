...
def GetToken():
    tok = guest_token("3718802330", "416BA9DF21FC66D9A6F011D1E20C89CE1D0F317EFAE0DE4A40B23677E62300C5")
    return tok
...
def main() -> None:
    app = ApplicationBuilder().token("8171416278:AAFA34kKi7IEuAkil1tq5XQcWplvOGgrK7g").build()
